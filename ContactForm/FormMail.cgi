...
$captcha_datadir = "/home/sites/liamcrosby.co.uk/public_html//../.captcha_data";
...
$captcha_outputdir = "/home/sites/liamcrosby.co.uk/public_html/ContactForm/img";
...
sub send_mail {
    ...
    else                    { print MAIL "Subject: Communication from visitor to website liamcrosby.co.uk\n\n" }
...
<html>
 <head>
  <title>Error: Bad image verification code</title>
 </head>
 <body bgcolor=#FFFFFF text=#000000>
  <center>
   <table border=0 width=600 bgcolor=#9C9C9C>
    <tr><th><font size=+2>Error: Bad image verification code</font></th></tr>
   </table>
   <table border=0 width=600 bgcolor=#CFCFCF>
    <tr><td>The entered image verification code was incorrect, please try again.<hr size=1>
