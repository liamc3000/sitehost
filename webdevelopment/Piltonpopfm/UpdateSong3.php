...
$sql="UPDATE playlist3 SET SongID='$SongID', ArtistID='$ArtistID', AlbumID='$AlbumID', YearID='$YearID', DurationID='$DurationID' WHERE CatalogID='$CatalogID'";
...
$result = mysql_query("SELECT SongID, ArtistID, AlbumID, YearID, DurationID, CatalogID FROM playlist3 WHERE CatalogID=$CatalogID");
if (!$result) {
